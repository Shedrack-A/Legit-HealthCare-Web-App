...
export const CONSULTATION_FIELDS: FormField[] = [
  ...
  {
    name: 'chronic_chest_pain',
    label: 'Chronic Chest Pain',
    type: 'select',
    options: ['Yes', 'No'],
  },
  {
  ...
  { name: 'murmur', label: 'Murmur', type: 'select', options: ['Yes', 'No'] },
  {
    ...
    label: 'Chest',
    type: 'select',
    options: ['Clinically Clear', 'Not Clear'],
  },
  {
    name: 'prostrate_specific_antigen',
    label: 'Prostrate-Specific Antigen - PSA',
    type: 'select',
    options: ['Negative', 'Positive', 'Not Applicable'],
  },
  {
    name: 'psa_remark',
    label: 'PSA Remark',
  ...
  {
    name: 'fbs_rbs_remark',
    label: 'FBS/RBS Remark',
    type: 'select',
    options: ['Normal', 'Abnormal', 'Maybe Abnormal'],
  },
  {
    name: 'urine_analysis',
  ...
  { name: 'spo2', label: 'SPO2%', type: 'text' },
  {
    ...
    label: 'HS: 1&2',
    type: 'select',
    options: ['Present', 'S3 Present', 'S4 Present'],
  },
  {
    name: 'breast_exam',
    label: 'Breast Exam',
    type: 'select',
    options: ['Not Applicable', 'Normal', 'Abnormal'],
  },
  {
    name: 'breast_exam_remark',
    label: 'Breast Exam Remark',
    type: 'textarea',
    fullWidth: true,
  },
  {
  ...
  {
    name: 'assessment_hx_pe',
    label: 'Assessment - HX/PE',
    type: 'select',
    options: [
      'Satisfactory',
      'Elevated BP',
  ...
  {
    name: 'overall_lab_remark',
    label: 'Overall Lab Remark',
    type: 'textarea',
    fullWidth: true,
  },
  {
...
export const SPIROMETRY_FIELDS: FormField[] = [
  ...
  {
    name: 'spirometry_remark',
    label: 'Spirometry Remark',
    type: 'textarea',
    fullWidth: true,
  },
];
...
export const AUDIOMETRY_FIELDS: FormField[] = [
  {
    ...
    label: 'Audiometry Result',
    type: 'textarea',
    fullWidth: true,
  },
  {
    name: 'audiometry_remark',
    label: 'Audiometry Remark',
    type: 'textarea',
    fullWidth: true,
  },
];
