              ...
              <Routes>
                ...
                <Route element={<ProtectedRoute />}>
                  ...
                  >
                    ...
                    />
                    <Route
                      path="/consultation/form/:staffId"
                      element={<ConsultationFormPage />}
                    />
                    <Route
                      path="/test-results"
                      element={<TestResultsLandingPage />}
                    />
                    <Route
                      path="/test-results/:testType/search"
                      element={<TestResultSearchPage />}
                    />
                    <Route
                      path="/test-results/:testType/form/:staffId"
                      element={<TestResultFormPage />}
                    />
                    <Route
                      path="/director-review/search"
                      element={<DirectorReviewSearchPage />}
                    />
                    <Route
                      path="/director-review/form/:staffId"
                      element={<DirectorReviewFormPage />}
                    />
                    <Route
                      path="/patient-report/search"
                      element={<PatientReportSearchPage />}
                    />
                    <Route
                      path="/patient-report/view/:staffId"
                      element={<PatientReportPage />}
                    />
                    <Route
                      path="/view-patients"
                      element={<ViewPatientsPage />}
                    />
                    <Route
                      path="/edit-patient/:staffId"
                    ...
                    />
                    <Route
                      path="/control-panel/edit-user/:userId"
                      element={<EditUserPage />}
                    />
                    <Route
                      path="/control-panel/role-management"
                      element={<RoleManagementPage />}
                    />
                    <Route
                      path="/control-panel/temp-access-codes"
                      element={<TempAccessCodePage />}
                    />
                    <Route
                      path="/control-panel/audit-log"
                      element={<AuditLogPage />}
                    />
                    <Route
                      path="/control-panel/email-config"
                      element={<EmailConfigPage />}
                    />
                    <Route
                      path="/control-panel/branding"
